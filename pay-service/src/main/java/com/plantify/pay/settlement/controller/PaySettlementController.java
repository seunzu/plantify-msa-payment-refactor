...
public class PaySettlementController {
    ...
    public ApiResponse<Page<PaySettlementResponse>> getAllPaySettlements(Pageable pageable) {
        Page<PaySettlementResponse> response = paySettlementQueryService.getAllPaySettlements(pageable);
    ...
    public ApiResponse<Page<PaySettlementResponse>> getPaySettlementByStatus(
        ...
        Page<PaySettlementResponse> paySettlementByStatus = paySettlementQueryService.getPaySettlementByStatus(status, pageable);
    ...
    public ApiResponse<Long> getPaySettlementAmount() {
        Long amount = paySettlementQueryService.getPaySettlementAmount();
